...
| --- | --- | --- | --- | --- | --- |
| Scout / mapping | `luna_scout_standard` | `gpt-5.6-luna` | `medium` | `standard` (inherited) | read-only |
| Implementation / write | `luna_worker_standard` | `gpt-5.6-luna` | `high` | `standard` (inherited) | workspace-write |
| Adversarial review | `luna_critic_standard` | `gpt-5.6-luna` | `high` | `standard` (inherited) | read-only |
| Validation / test | `luna_tester_standard` | `gpt-5.6-luna` | `medium` | `standard` (inherited) | workspace-write |
| General bounded analysis | `luna_max_standard` | `gpt-5.6-luna` | `max` | `standard` (inherited) | read-only |

Role selection is a policy decision, not an automatic guarantee that every
task should be delegated. `luna_max_standard` is an exception path only. Its
